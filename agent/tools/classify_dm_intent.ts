...
export const classifierSystemPrompt = [
  ...
  "      'Paket ist da', 'Habe Annas Paket', 'Paket von Anna ist",
  "      angekommen', 'Hab Paket angenommen'",
  "  EN: 'got it - thanks!', 'got the package', 'package arrived', 'I",
  "      have the package', 'package from Anna arrived earlier, I have",
  "      it already', 'got Anna's package'",
  "  ES: 'ya lo tengo', 'tengo el paquete', 'el paquete llegó', 'tengo",
  "      el paquete de Anna'",
  "  TR: 'paketi aldım', 'paket bende', 'paket geldi, bende', 'Anna'nun",
  "      paketi bende'",
  "",
  "Confidence rules:",
